...
<div class="container-fluid bg-breadcrumb">
    <div class="container text-center py-5" style="max-width: 900px;">
        <h3 class="text-white display-3 mb-4">Evaluasi Kinerja</h1>
        <ol class="breadcrumb justify-content-center mb-0">
            <li class="breadcrumb-item"><a href="index.html">Beranda</a></li>
            <li class="breadcrumb-item active text-white">Perangkat Daerah Pemerintah Kabupaten Bengkalis</li>
        </ol>    
    </div>
</div>
<!-- Header End -->
...
<div class="container-fluid guide py-5">
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            <h5 class="section-title px-3">Data Evaluasi Kinerja</h5>
            <h3 class="mb-0">{{$opd->nama}} Kabupaten Bengkalis</h3>
        </div>
...
{{-- begin::custom js --}}
@push('scripts')
    @include('frontend.evaluasilhe.script')
@endpush
{{-- end::custom js --}}
{{-- end::aditional js --}}
@endsection