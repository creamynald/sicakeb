                        ...
                        <table id="myTable" class="table align-middle table-row-dashed fs-6 gy-5">
                            <thead>
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-30px">Kegiatan</th>
                                    <th class="min-w-125px">Sub Kegiatan</th>
                            ...
                            <form id="formData" method="POST">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="kegiatan_id" class="required fs-6 fw-semibold mb-2">Kegiatan</label>
                                        <select name="kegiatan_id" id="kegiatan_id" class="form-select form-select-solid">
                                    ...
                                    <div class="form-group">
                                        <label for="nama" class="required fs-6 fw-semibold mb-2">Sub Kegiatan</label>
