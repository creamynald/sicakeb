                        ...
                        <table id="" class="table align-middle table-bordered fs-6 gy-5">
                            <thead>
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    <th class="text-center middle-align" rowspan="3">No</th>
                                    <th class="text-center middle-align" rowspan="3">Sasaran</th>
                                    <th class="text-center middle-align" rowspan="3">Indikator</th>
                                    <th class="text-center middle-align" rowspan="3">Anggaran</th>
                                    <th class="text-center middle-align" rowspan="3">Target Kinerja Tahunan</th>
                                    <th class="text-center" colspan="8">Target/Realisasi</th>
                                </tr>
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
