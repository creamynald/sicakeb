...
<head>
    ...
    <meta property="og:title"
        content="{{ config('app.name') }} - {{ config('app.subname') }}" />
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
                ...
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    ...
                    <a href="#" class="mb-0 mb-lg-12">
                        <img alt="Logo" src="{{asset('assets/favicon/Logo_SiCakeb.png')}}" class="h-60px h-lg-75px" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Image-->
                    ...
                    <!--end::Title-->
                    <!--begin::Text-->
                    <div class="d-none d-lg-block text-white fs-base text-center">Mengukur,
                        <a href="#" class="opacity-75-hover text-warning fw-bold me-1">Capaian Kinerja</a>Kabupaten Bengkalis
                        <br />Menuju
                        <a href="#" class="opacity-75-hover text-warning fw-bold me-1">Bengkalis Bermasa</a>
                    </div>
                    <!--end::Text-->
                </div>
                <!--end::Content-->
